...
class AE_Primer_Type901(Generic_Net):
    """
    Vanila AE.
    """
    def __init__(
...
class VAE_Stacked_Dilo_Anndata_Type902(nn.Module):
    """
...
class VAE_Dirichlet_Type910(nn.Module):
    """
...
class VAE_Dirichlet_Type911(nn.Module):
    """
    made some changes to the forward functions,
    loss_y_alt, not tanh on logvars
    dirscale: scale of loss_d
...
class VAE_Dirichlet_Type912(nn.Module):
    """
    made some changes to the forward functions,
    loss_y_alt, not tanh on logvars
    dirscale: scale of loss_d
