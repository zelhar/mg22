...
class VAE_AE_Type1500v(nn.Module):
    """
    vanilla VAE
    """
...
class VAE_AE_Type1500vC(nn.Module):
    """
    ...
    def forward(
        ...
        mu_z_prior = z_mu_logvar_prior[:, : self.nw]
        logvar_z_prior = z_mu_logvar_prior[:, : self.nw]
        if self.restrict_z == "lv":
...
class VAE_Dirichlet_GMM_Type1602xzC(nn.Module):
    """
    conditional version
    """
...
class VAE_Dirichlet_GMM_Type1602zC(nn.Module):
    """
    conditional version
    """
