...
#####
class VAE_Dirichlet_GMM_TypeB1602zR(nn.Module):
    """ """
...
class VAE_Dirichlet_GMM_TypeB1602xzR(nn.Module):
    """ """
    ...
    def __init__(
        ...
        if use_resnet:
            #resnet_wz = models.resnet101()
            resnet_wz = models.resnet18()
            #resnet_wz.conv1 = nn.Conv2d(1, 28, (7,7), (2,2), (3,3), bias=False)
            resnet_wz.conv1 = nn.Conv2d(1, 64, (7,7), (2,2), (3,3), bias=False)
            self.Qwz = nn.Sequential(
                    nn.Flatten(1),
                    nn.Linear(nx, nhq),
...
class VAE_Dirichlet_GMM_TypeB1602V2(nn.Module):
    """ """
    ...
    def __init__(
        ...
        self.Qy = ut.buildNetworkv5(
            # [nx + nw + nz] + numhiddenq*[nhq] + [nclasses],
            # [nx + nz] + numhiddenq*[nhq] + [nclasses],
            [nx + nz + nw] + numhiddenq * [nhq] + [nclasses],
            dropout=dropout,
            # activation=nn.LeakyReLU(),
            # activation=nn.Sigmoid(),
            activation=activation,
