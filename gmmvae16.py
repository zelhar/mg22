...
class VAE_Dirichlet_GMM_Type1602xzMNIST(nn.Module):
    """
    made some changes to the forward functions,
    loss_y_alt, not tanh on logvars
    dscale: scale of loss_d
    ...
    def __init__(
        ...
        temperature : float = 0.1,
        relax : bool = False,
        use_resnet_y: bool = False,
        use_resnet_wz: bool = False,
        ...
        self.do_cc = do_cc
        self.softargmax = softargmax
        self.use_resnet_y = use_resnet_y
        self.use_resnet_wz = use_resnet_wz
