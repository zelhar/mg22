...
\definecolor{beamerfg}{rgb}{0.23, 0.27, 0.29}
\definecolor{beamerfg2}{rgb}{0.13, 0.17, 0.49}
\setbeamercolor{background canvas}{bg=beamerbg}
%\setbeamercolor{normal text}{fg=beamerfg}
%\setbeamercolor{alerted text}{fg=beamerfg2}
\setbeamercolor{structure}{fg=beamerfg2}
%\setbeamercolor{frametitle}{fg=beamerfg}


\def\shrug{\texttt{
\raisebox{0.75em}{\char`\_}\char`\\\char`\_\kern-0.5ex(\kern-0.25ex\raisebox{
0.25ex}{\rotatebox{45}{\raisebox{
-.75ex}"\kern-1.5ex\rotatebox{-90})}}\kern-0.5ex)\kern-0.5ex\char`\_/\raisebox{0.75em}{\char`\_}}}
...
\begin{frame}
\frametitle{VAE can represent the true distribution of the data}
VAE is a prbabilistic model. Theoretically, by choosing the correct type of
distribution model, it can "learn" to represent the true distribution of the
data.
\end{frame}
...
\begin{itemize}
\item{} Martin Vingron
\item{} MPG and Group V
\item{} Tim Conrad
\end{itemize}
\large{big warm thank you!}
