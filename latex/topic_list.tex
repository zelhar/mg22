...
When professor Vingron and I originally set up on theme for exploration towards a thesis, 
...
Pretty soon I found out that we are dealing with datasets of gene expression
...
other factors but in the papers I've read it's mainly the cell type so that's
our main focus here too.

So now while doing preliminary research into neural networks I am thinking,
cell types, that's like categorical data, it sounds like I am dealing with
classification task, unsupervised learning, something like that, how can an
autoencoder help me with that. 
I've seen pretty soon how autoencoders and the like are used on RNASeq and
similar data; Basically it's about replacing PCA with an AE, VAE or some fancier 
derivative. The rest of the analysis is pretty much identical. Another use is
for batch effect reduction by way of a conditional model.
Not very exciting.

The entire construct that is VAE was invented, as far as I know, by
Kingma and Welling. About two or three followups from their original paper you
get into their paper on semisupervised learning. Nice. But soon you find out
from the comments that it just doesn't work unsupervised. Then a little bit more
search got me into the Gauss mixture model VAE of Dilokthanakul, this one seems
to work also in unsupervised learning, so I settled on it as the base model to
experiment with.
By the end of this thesis, my goal is to provide a skeptical 
overview of what these models are good for as well as their limitations.
...
can be found in the Scnapy~\cite{wolf2018scanpy} documentation, a tool we made
good use with in this thesis.
...
%the conditional version of our mixture model, cGMVAE, 
