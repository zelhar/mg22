...
but it has $28 \cdot 28 \cdot 3$ dimesnions in total. It has 3 \emph{axes},
whose repective sizes are
$28$, $28$, and $3$. 
...
axis}.
We call $\x_i = \x[i]$, which is the $k-1$ dimensional sub-array with the first
...
If $\x,\y$ have the same number of axes and their repective axes sizes are equal
