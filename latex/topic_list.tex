...
This is another motivation why we take mean over the batch dimension, because
...
for example, to classify $\x$. For this reason we are
interested in knowing the flipped conditional distribution $p(\z | \x)$.
